...
export const books = [
  {
    ...
    description: "It all started with a goat named Gary... Discover the WILD journey from trading chickens to Bitcoin!",
    teaser: "🐐 Why did humans invent money anyway?",
    hook: "Spoiler: It wasn't always coins and cards. People once paid with shells, salt, and yes... goats!",
  ...
  },
  {
    ...
    description: "Banks get hacked. People lie. Records vanish. So someone invented an UNBREAKABLE chain of truth!",
    teaser: "⛓️ What if nobody could cheat?",
    hook: "Blockchains exist because humans just can't behave. It's like a permanent report card for EVERYTHING.",
